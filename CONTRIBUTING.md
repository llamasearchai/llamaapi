# Contributing to LlamaApi

Thank you for your interest in contributing to LlamaApi! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaApi:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaapi.git
   cd llamaapi
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaapi.git
   ```
...
By contributing to LlamaApi, you agree that your contributions will be licensed under the project's MIT License.
