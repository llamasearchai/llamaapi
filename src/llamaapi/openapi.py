...
from llamaapi.schema import URL, Boolean, DateTime
from llamaapi.schema import Dict as DictField
from llamaapi.schema import Email, Field, Float, Integer
from llamaapi.schema import List as ListField
from llamaapi.schema import Schema, String
from llamaapi.server import API, HttpMethod, Route
...
def _convert_field_to_openapi(field: Field) -> Dict[str, Any]:
    ...
    if isinstance(field, String):
        openapi_type = "string"
        if isinstance(field, Email: nikjois@llamasearch.ai
