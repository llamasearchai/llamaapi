...
from src.llamaapi.schema import Dict as DictField
from src.llamaapi.schema import (
    Email,
    Field,
    Float,
...
class TestSchemaValidation(unittest.TestCase):
    ...
    def test_email_validation(self):
        ...
        # Valid emails
        self.assertEqual(
            field.validate("user@example.com", "email"), "user@example.com"
        )
        self.assertEqual(
            field.validate("user.name+tag@example.co.uk", "email"),
    ...
    def test_datetime_validation(self):
        ...
        self.assertIsInstance(
            field.validate("2023-01-01T12:00:00", "timestamp"), datetime.datetime
        )
        self.assertIsInstance(
            field.validate("2023-01-01T12:00:00Z", "timestamp"), datetime.datetime
        )
        self.assertIsInstance(
            field.validate("2023-01-01T12:00:00+00:00", "timestamp"), datetime.datetime
        )
    ...
    def test_dict_validation(self):
        ...
        self.assertEqual(
            field.validate(
                {"name": "John", "age": 30, "email": "john@example.com"}, "user"
            ),
